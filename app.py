...
def apply_theme(is_dark):
    ...
    * { box-sizing: border-box; }
    ...
    /* Sidebar - selalu terang dan teks gelap */
    ...
    section[data-testid="stSidebar"] .sidebar-brand {
        background: linear-gradient(135deg, #1E3A2B, #2D5F3F) !important;
        color: #fff !important;
    }
    section[data-testid="stSidebar"] .sidebar-brand * {
        color: #fff !important;
    }
    /* Commodity brief di sidebar */
    section[data-testid="stSidebar"] .commodity-brief {
        background: #F5EFE0 !important;
        border-left-color: var(--heritage) !important;
    }
    section[data-testid="stSidebar"] .commodity-brief * {
        color: #1A2B20 !important;
    }
    ...
    section[data-testid="stSidebar"] .sidebar-title {
        ...
        border-bottom-color: #E5DFD0 !important;
    }
